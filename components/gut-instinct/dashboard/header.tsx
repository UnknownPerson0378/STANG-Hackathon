        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 h-9 px-4 rounded-md bg-primary text-primary-foreground font-medium shadow-lg shadow-primary/20 hover:bg-primary/80 hover:text-primary-foreground hover:shadow-primary/30 transition-all"
            >
            ...
            <button
              ...
              className="sm:hidden inline-flex items-center justify-center h-9 w-9 rounded-md bg-primary text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground shadow-lg shadow-primary/20"
            >
              <Plus className="w-4 h-4" />
            </button>
